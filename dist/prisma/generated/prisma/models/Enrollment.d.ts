...
export type EnrollmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "courseId" | "studentId" | "paymentId" | "status" | "progress" | "enrolledAt" | "updatedAt" | "completedAt", ExtArgs["result"]["enrollment"]>;
